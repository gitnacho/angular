...
* For a **Major Feature**, first open an issue and outline your proposal so that it can be discussed.
  ...
  **Nota**: Adding a new topic to the documentation, or significantly re-writing a topic, counts as a major feature.
...
9. Commit your changes using a descriptive commit message that follows our [commit message conventions](#commit).
   Adherence to these conventions is necessary because release notes are automatically generated from these messages.
     ...
     git commit --all
     ```
    Nota: the optional commit `-a` command line option will automatically "add" and "rm" edited files.

10. Envía tu rama a *GitHub*.
...
¡Eso es todo! ¡Gracias por tu aportación!
...
* `packaging` ⏤ utilizado para cambios que cambian la composición del paquete `npm` en todos nuestros paquetes, p. ej. cambios de ruta pública, cambios de `package.json` realizados en todos los paquetes, cambios de formato/archivo d.ts, cambios en paquetes, etc.
