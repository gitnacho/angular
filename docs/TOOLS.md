...
In the browser open the developer console (Ctrl + Shift + j in Chrome). El
...
any user actions should result in no changes to be applied on the UI. Es
...
Angular also supports a second type of change detection - the "push" model. En
