...
- cualquier ruta de archivo/importación dentro de nuestro paquete, excepto `/`, `/testing` y `/bundles/*` y otros puntos de entrada de paquetes documentados.
- constructores de clases inyectables (servicios y directivas) ⏤ utiliza *ID* para obtener instancias de estas clases
