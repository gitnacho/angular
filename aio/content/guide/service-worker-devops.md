...
archivo. A service worker ignores such constraints and effectively long
...
directory at the time the manifest was built. Otro
...
It is important to note that service workers don't work behind redirect. Se
