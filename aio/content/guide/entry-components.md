...
## Un componente de entrada `bootstrapped`


El siguiente es un ejemplo de cómo especificar un componente de arranque,
`AppComponent`, en un `app.module.ts` básico ⏤
...
@NgModule({
  ...
  providers: [],
  bootstrap: [AppComponent] // componente de entrada 'bootstrapped'
})
```
