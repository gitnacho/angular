...
class Location_2 {
    ...
    static joinWithSlash: (inicio: string, end: string) => string;
...
export class NgPluralCase {
    constructor(valor: string, template: TemplateRef<Object>, viewContainer: ViewContainerRef, ngPlural: NgPlural);
    // (undocumented)
    valor: string;
    // (undocumented)
...
export class SlicePipe implements PipeTransform {
    // (undocumented)
    transform<T>(value: ReadonlyArray<T>, start: number, fin?: number): Array<T>;
    // (undocumented)
    transform(value: null | undefined, start: number, fin?: number): null;
    // (undocumented)
    transform<T>(value: ReadonlyArray<T> | null | undefined, start: number, fin?: number): Array<T> | null;
    // (undocumented)
    transform(value: string, start: number, fin?: number): string;
    // (undocumented)
    transform(value: string | null | undefined, start: number, fin?: number): string | null;
    // (undocumented)
