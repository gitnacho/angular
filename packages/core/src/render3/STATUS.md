...
- `@angular/compiler-cli` ⏤ Canalización de transformadores de *TypeScript* que incluye dos herramientas de línea de comandos:
  - `ngtsc` ⏤ (Compilador *Angular TypeScript*) Compilador *Angular* que elimina `@Component` (y amigos) y lo reemplaza con `ɵɵdefineComponent` (y amigos).
...
- `@angular/compiler` ⏤ *Ivy Compiler* que convierte el decorador en `ivy`
