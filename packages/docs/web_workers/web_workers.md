# WebWorkers in Angular: Documentación
...
[MessageBroker](#messagebroker) instructing the UI to run the actual method and return the result. El
...
**Nota**: If you want to pass custom messages between the UI and WebWorker, it's recommended you use the
...
**Nota**: Because the messages passed through the MessageBus cross a WebWorker boundary, they must be serializable.
...
**Nota**: Implementing and using a Custom MessageBus is experimental and the APIs may change.
